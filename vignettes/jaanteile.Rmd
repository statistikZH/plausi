...
predicted_results <- predict_votes(c("v6330","v6310"),train=train, test=data ,exclude_votes = TRUE, geovars=c("mun_id","mun_name" ))
...
Lets say we'd want to compare different models in terms of acuracy.
...
comparison <- map_dfr(models, ~test_models(votes=colnames(train)[c(-1,-2)][3],
                                        train=train,
                                        test=test,
                                        model=.x,
